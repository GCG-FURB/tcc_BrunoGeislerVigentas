...
public class ARCamera : MonoBehaviour
{
    ...
    //M�todo respons�vel por resetar componentes ao restartar a aplica��o.
    ...
    //Realiza configura��es iniciais ao come�ar a aplica��o.
    void OnEnable()
    {
        if (m_CameraManager != null)
        {
    ...
    //Faz alguns processamentos iniciais na imagem, convertento a imagem em uma textura RGB para  ser processada mais facilmente para a rotina de detec��o.
    ...
    //M�todo que filtra bouding boxes adicionando e filtrando as bouding boxes de v�rios frames. 
    ...
    //Compara dois objetos para ver se s�o iguais, caso for o que tem o maior score de confidence � utilizado.
